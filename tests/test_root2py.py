...
input = CURDIR+"/tests/skim_small_photons_0PU_bc_stc_hadd.root" ###Input root file path
output = CURDIR+"/tests/skim_small_photons_0PU_bc_stc_hadd.hdf5" ###Output hdf path
output2 = CURDIR+"/tests/skim_small_photons_0PU_bc_stc_hadd.pkl" ###Output pkl path
